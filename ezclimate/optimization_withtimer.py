...
class GeneticAlgorithm(object):
	...
	def run(self):
		...
		for g in range(0, self.num_gen):
			...
			gt_start = dt.timedelta(hours=gt_start.hour, minutes=gt_start.minute, seconds=gt_start.second, microseconds=gt_start.microsecond)
			gt_end = dt.timedelta(hours=gt_end.hour, minutes=gt_end.minute, seconds=gt_end.second, microseconds=gt_end.microsecond)
			...
			et_start = dt.timedelta(hours=et_start.hour, minutes=et_start.minute, seconds=et_start.second, microseconds=et_start.microsecond)
			et_end = dt.timedelta(hours=et_end.hour, minutes=et_end.minute, seconds=et_end.second, microseconds=et_end.microsecond)
