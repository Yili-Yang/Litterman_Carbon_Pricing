...
def base_case():
    print('Start',dt.datetime.time(datetime.datetime.now()))
    t = TreeModel(decision_times=[0, 15, 45, 85, 185, 285, 385])
    print('End tree',dt.datetime.time(datetime.datetime.now()))
    bau_default_model = DLWBusinessAsUsual()
    bau_default_model.bau_emissions_setup(tree=t)
    print('End bau',dt.datetime.time(datetime.datetime.now()))
    ...
    print('End cost',dt.datetime.time(datetime.datetime.now()))
    ...
    print('End damage',dt.datetime.time(datetime.datetime.now()))
    u = EZUtility(tree=t, damage=df, cost=c, period_len=5.0, eis=0.9, ra=7.0, time_pref=0.005)
    print('End utility',dt.datetime.time(datetime.datetime.now()))
    ...
    print('End opt/End',dt.datetime.time(datetime.datetime.now()))
